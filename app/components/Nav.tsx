    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 60 }}>
        ...
        <div style={{ display: "flex", gap: 32, alignItems: "center" }} className="desktop-nav">
          ...
          <a href="/Rahul_Khanchandani_Resume.pdf" target="_blank" style={{ fontFamily: "DM Mono, monospace", fontSize: 12, color: "#58A6FF", textDecoration: "none", border: "1px solid rgba(88,166,255,0.4)", padding: "6px 16px", borderRadius: 4, transition: "all 0.2s" }}
